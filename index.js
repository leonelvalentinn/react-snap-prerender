...
const preloadResources = (opt) => {
  ...
  page.on("response", async (response) => {
    ...
    // console.log("responseUrldata",responseUrl);
    // console.log("basePathdata",basePath);
    const route = responseUrl.replace(basePath, "");
    // console.log("initialRoutes",route);
...
const run = async (userOptions, { fs } = { fs: nativeFs }) => {
  ...
  await crawl({
    ...
    afterFetch: async ({ page, route, browser, addToQueue }) => {
      ...
      // console.log("publicPathpublicPath",publicPath);
      ...
      if (options.saveAs === "html") {
        // console.log("beforeSaveashtml",page, filePath, options, route, fs)
